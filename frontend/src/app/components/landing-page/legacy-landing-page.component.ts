        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-16">
            <div class="flex items-center space-x-2">
              <img src="assets/ypa_logo.png" alt="YPA Logo" class="h-10 w-auto">
              <span class="text-2xl font-extrabold text-blue-600 tracking-tight">YPA-HANDAYANI</span>
            </div>
      ...
      <section id="keunggulan" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-4">Mengapa Memilih YPA-HANDAYANI?</h2>
            <p class="text-xl text-gray-500 max-w-2xl mx-auto">Kami mengerti masalah absensi Anda. YPA-HANDAYANI hadir sebagai solusi yang nyaman dan aman.</p>
          </div>
                  ...
                  <div class="absolute top-4 left-4 right-4 bottom-4 bg-white rounded-xl overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-5 py-3 flex items-center justify-between">
                      <div class="flex items-center space-x-3">
                        <span class="text-white font-bold text-sm tracking-wider text-left">YPA-HANDAYANI</span>
                        <span class="text-blue-200 text-xs">|</span>
                        <span class="text-blue-200 text-xs text-left">Panel Manajer</span>
                      </div>
                      <div class="flex items-center space-x-2">
      ...
      <section class="bg-blue-900 py-20 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p class="text-xl text-blue-200 mb-10 max-w-2xl mx-auto">
            Bergabunglah dengan perusahaan modern yang telah beralih ke YPA-HANDAYANI.
      ...
      <section id="kontak" class="py-20 bg-gray-50 border-t border-gray-100">
        <div class="max-w-4xl mx-auto px-4 text-center">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <!-- WhatsApp Option -->
            <a href="https://wa.me/6285171213154?text=Halo%20Tim%20YPA-HANDAYANI,%20saya%20tertarik%20dengan%20sistem%20absensi%20ini." target="_blank" class="block bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1 group border border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex flex-col md:flex-row justify-between items-center">
            <div class="mb-6 md:mb-0 text-left">
              <span class="text-2xl font-bold text-white tracking-widest">YPA-HANDAYANI</span>
              <p class="mt-2 text-sm text-gray-400">Sistem Manajemen Presensi Modern</p>
            </div>
          ...
          <div class="mt-8 border-t border-gray-800 pt-8 text-sm">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
              <div class="text-center md:text-left">
                &copy; 2026 YPA-HANDAYANI. All rights reserved. Made by <span class="text-gray-300 font-medium">Andi Alifsyah</span> and <a href="https://www.instagram.com/simistudio.co/" target="_blank" class="text-gray-300 font-medium hover:text-white transition">Simi Studio</a>.
              </div>
